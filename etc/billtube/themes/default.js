    ...
    var scheme = {
		...
		'video-size': {
            ...
            options: [
                ...
                {value: 'huge', title: app.t('theme[.]Huge')},
...
function randomInt(min, max) {
    ...
    var applySettings = function (storage) {
        ...
        if (storage.get('video-size') === 'big') {
         $("body").get(0).style.setProperty("--chatwidth", "300px");
        } 
		if (storage.get('video-size') === 'small') {
        $("body").get(0).style.setProperty("--chatwidth", "400px");         
        }
		if (storage.get('video-size') === 'smaller') {
        $("body").get(0).style.setProperty("--chatwidth", "555px"); 
        }
		if (storage.get('video-size') === 'huge') {
        $("body").get(0).style.setProperty("--chatwidth", "800px"); 
        }
